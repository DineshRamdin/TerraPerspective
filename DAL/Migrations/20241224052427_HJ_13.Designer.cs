...
namespace DAL.Migrations
{
    ...
    [Migration("20241224052427_HJ_13")]
    partial class HJ_13
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Administration.SYS_AccessRights", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SYS_AccessRights");
                });

            modelBuilder.Entity("DAL.Models.Administration.SYS_AccessRightsDetails", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SYS_AccessRightsDetails");
                });
            ...
            modelBuilder.Entity("DAL.Models.Administration.SYS_Modules", b =>
                {
                    ...
                    b.Property<bool?>("HasAutoGeneratedCode")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DAL.Models.Administration.SYS_ProjectFolderFiles", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SYS_ProjectFolderFiles");
                });
            ...
            modelBuilder.Entity("DAL.Models.Administration.SYS_ProjectsMatrix", b =>
                {
                    b.Property<long>("MID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DAL.Models.Administration.SYS_Reports", b =>
                {
                    ...
                    b.Property<string>("ReportImagebase64")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.Administration.SYS_SystemIcon", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("SystemIconImagebase64")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.Administration.SYS_ZoneManagement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("SYS_ZoneManagement");
                });

            modelBuilder.Entity("DAL.Models.Administration.SYS_ZoneMatrix", b =>
                {
                    b.Property<long>("MID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DAL.Models.Administration.SYS_AccessRights", b =>
                {
                    b.HasOne("DAL.Models.Administration.SYS_Modules", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.Administration.SYS_AccessRightsDetails", b =>
                {
                    b.HasOne("DAL.Models.Administration.SYS_AccessRights", "AccessRights")
                        .WithMany()
